            ...
            <%@taglib prefix="t" tagdir="/WEB-INF/tags" %>
                ...
                <t:layout>
                    <button type="button" class="btn btn-primary m-5" data-bs-toggle="modal"
                        data-bs-target="#adicionarProjetoModal">
                        Adicionar Projeto
                    </button>
                    <div class=" m-4">
                                ...
                                <div class="col-sm-4  mt-md-2 h-100 mb ">
                                        ...
                                        <div class="card shadow p-3 m-3 bg-white rounded">
                                            ...
                                            <div class="card-header d-flex justify-content-between">
                                                <div>
                                                    <h6 class="text-left d-block      m-2">Inicio: ${projeto.dataInicio}
                                                    </h6>
                                                    <h6 class="text-left d-block     m-2">
                                                        Previsão: ${projeto.dataPrevisaoFim}</h6>
                                                    <c:if test="${projeto.status == 'Encerrado'}">
                                                        <h6 class="text-left d-block m-2">
                                                            Encerrado em: ${projeto.dataFim}
                                                        </h6>
                                                    </c:if>
                                                </div>
                                                <div>
                                                    <span
                                                        class="text-right d-block badge bg-primary m-2">${projeto.risco}</span>
                                                    <span
                                            ...
                                            <div class="card-footer p-3   text-dark">
                                                <div
                                                    class="container-circle  align-items-center justify-content-center ">
                                                    <c:forEach items="${projeto.primeiroInicialNomeMembros}"
                                                        var="membro">
                                                ...
                                                <div class="card-header d-flex justify-content-between">
                                                    <div>
                                                        <h6 class="text-left d-block      m-2">${projeto.gerente.nome}
                                                        </h6>
                                                    </div>
                                                    <div>
                                                        <span class="text-right d-block  m-2">
                                                            <fmt:formatNumber type="currency" currencyCode="BRL"
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="adicionarProjetoModal" tabindex="-1"
                        aria-labelledby="adicionarProjetoModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="projetos/adicionar" method="POST">
                                        ...
                                        <div class="row mb-3">
                                            <label for="dataInicio" class="col-sm-2 col-form-label">Data de
                                                Início</label>
                                            <div class="col-sm-10">
                                        ...
                                        <div class="row mb-3">
                                            <label for="dataPrevisaoFim" class="col-sm-2 col-form-label">Data de
                                                Previsão de Fim</label>
                                            <div class="col-sm-10">
                                                <input type="date" class="form-control" id="dataPrevisaoFim"
                                                    name="dataPrevisaoFim" required>
                                            </div>
                                        </div>
                                        <div class="row mb-3">
